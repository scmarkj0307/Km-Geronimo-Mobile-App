...
<View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 80 }}>
  ...
  <TouchableOpacity
      ...
      style={{
        marginTop: '5%',
        marginBottom: '8%',
        backgroundColor: !isValid  || (!touched.firstInput && !touched.secondInput && !touched.thirdInput && !touched.fourthInput) ? 'rgba(200, 255, 255, 0.3)' : 'rgba(200, 255, 255, 0.9)'  , // Use translucent white color
        width: 250,
        height: 55,
        paddingVertical: 10,
        borderRadius: 15,
